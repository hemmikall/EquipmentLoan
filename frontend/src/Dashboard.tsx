 ...
 */
function EquipmentLoanDashboardItem({
  context
}: {
  ...
  const pluginName: string = 'EquipmentLoan';
...
//  component
export function renderEquipmentLoanDashboardItem(
  context: InvenTreePluginContext
) {
  checkPluginVersion(context);
  return <EquipmentLoanDashboardItem context={context} />;
}
