# EquipmentLoan- Frontend Code

This directory contains the frontend code for the EquipmentLoan plugin.
...
This will compile the frontend into the `../equipmentloan/static` directory (ready for distribution).
